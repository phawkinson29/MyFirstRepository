...
prob1a.fun(5, 4)
```
Yes I did get the correct value. 
...
prob1c.fun(4, 5)
```
Yes, I did get the correct result. 
...
```{r eval=FALSE}
microbenchmark::microbenchmark( for.duniform( seq(-4,12,by=.0001), 4, 8), times=100)
```
